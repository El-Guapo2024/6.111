...
set_property -dict {PACKAGE_PIN D11 IOSTANDARD LVCMOS33} [get_ports "GPIO1"]
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33} [get_ports "GPIO2"]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports "GPIO3"]
...
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33}  [ get_ports "s[0]" ]
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33}  [ get_ports "s[1]" ]
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33}  [ get_ports "s[2]" ]
